...
if INCLUIR_FLUIDO:
    ...
    lado1 = largof-espacio_entre_puntos
    lado2 = anchof-espacio_entre_puntos*3
    altura = altof-espacio_entre_puntos*3#*1.5  # Altura total del bloque
    angulo_azimutal = 0
    angulo_zenital = 0
    plano = "x-y"
...
lado1 = alto  # Longitud del primer lado de la lámina
lado2 = ancho-delta*2   # Longitud del segundo lado de la lámina
angulo_azimutal = 0  # Ángulo azimutal en grados
angulo_zenital =  0  # Ángulo zenital en grados
espacio_entre_puntos = delta # Espacio entre puntos en la lámina
...
punto_inicial = np.array([largo-delta/2, delta, delta])
lado1 = alto  # Longitud del primer lado de la lámina
lado2 = ancho-delta*2   # Longitud del segundo lado de la lámina
angulo_azimutal = 0  # Ángulo azimutal en grados
angulo_zenital =  0  # Ángulo zenital en grados
...
generar_sph_snapshot(x, y, z, X_fluido, Y_fluido, Z_fluido, viscFluid=0.001002, viscWall=0.0, deltaf=delta*2, ddx=delta, ht=ht, x0=0, y0=0, filename='snapshot_000')
