...
def main():
    ...
    x_min = float(input("Límite mínimo de la caja en X (presiona Enter para usar 0.0): ") or "0.0")
    x_max = float(input("Límite máximoo de la caja en X (presiona Enter para usar 1.61): ") or "1.61")
    y_min = float(input("Límite mínimoo de la caja en Y (presiona Enter para usar 0.0): ") or "0.0")
    y_max = float(input("Límite máximoo de la caja en Y (presiona Enter para usar 0.15): ") or "0.15")
    z_min = float(input("Límite mínimoo de la caja en Z (presiona Enter para usar 0.0): ") or "0.0")
    z_max = float(input("Límite máximoo de la caja en Z (presiona Enter para usar 0.6): ") or "0.6")
