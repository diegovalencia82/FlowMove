      ...
      subroutine neighboring_search_P(rdomain,mspace,ntype,npairs,pairs, &
...
!c     mxiij      : matrix of xi-xj for all fluid particles for each interaction [out]            
      ...
      !$OMP PARALLEL DO private(i, j, k, rij, xij, yij, zij, vij, vxij,vyij, vzij)
...
!c      stop
      ...
      end subroutine neighboring_search_P
